...
class DefaultConfig(object):
    ...
    #SQLALCHEMY_DATABASE_URI = 'mysql://root:WOshifang520@127.0.0.1:3306/smallweb'  # 数据库
    SQLALCHEMY_BINDS = {
        'bj-m1': 'mysql://root:WOshifang520@127.0.0.1:3306/smallweb',
        'bj-s1': 'mysql://root:WOshifang520@127.0.0.1:3306/smallweb',
        'masters': ['bj-m1'],
        'slaves': ['bj-s1'],
        'default': 'bj-m1'
    }
